...
int main() {
	...
	vector<double> truth_table[432];
	vector<double> input_pattern[432];

	cout<<"Select the data set (1 or 2 or 3) : ";
	int idx;
	cin>>idx;
